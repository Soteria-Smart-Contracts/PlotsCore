...
contract NFTLoan{
    ...
    function DisperseRewards(address RewardToken) public {
        require(msg.sender == Owner || msg.sender == Borrower, "Loan is not active or expired, or not owner of token"); //Only owner can disperse rewards after loan has ended
        ...
        PlotsCoreV1(Manager).UpdatePayoutTracker(Borrower, RewardToken, RewardBalance - OwnerReward);
