...
contract NFTLoan{
    ...
    function BeginLoan(OwnershipPercent Ownership, address TokenOwner, address TokenBorrower, address Collection, uint256 TokenId, uint256 Duration, uint256 InitialValue) public OnlyManager {
    ...
    function DisperseRewards(address RewardToken) public {
        ...
        uint256 Fee = (RewardBalance * PlotsCore(PlotsCoreContract).CurrentRewardFee()) / 10000;
